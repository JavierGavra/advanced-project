...
<div class="max-w-2xl mx-auto py-8 px-4">
    ...
    <div class="bg-gray-800 rounded-2xl shadow-sm overflow-hidden">
        <div class="p-8">
            ...
            <form method="POST" action="/master/{{ $master->id }}/update" class="space-y-6">
                @csrf
                ...
                <div>
                    ...
                    >
                        ...
                        @if(isset($matkul) && is_array($matkul))
                            @foreach($matkul as $m)
                                @php
                                    $oldMatkul = $master['kode_matkul'] . ' - ' . $master['nama_matkul'];
                                    $selected = old('matkul', $oldMatkul) == $m ? 'selected' : '';
                                @endphp
